...
El usuario realiza cualquier acción dentro del sistema (registro, actualización, eliminación, consulta).

El sistema captura la acción automáticamente.

El sistema registra información relevante: usuario, fecha, hora, módulo y tipo de acción.

El sistema almacena el registro en el repositorio de auditoría.

Los registros quedan disponibles para consultas o generación de informes.
...
RN-28: Los registros de auditoría deben ser inalterables y verificables. (RNF-003.4)
...
RNF-003.4: Auditoría y registro de acciones de usuario.

RF-002.3: Repositorio central para auditorías e informes exhaustivos.

...
Actualmente, la empresa enfrenta dificultades operativas debido al manejo manual de la información y la falta de integración de sus datos. Esto ocasiona demoras en la certificación de estudiantes y redundancia de tareas. Adicionalmente, uno de los puntos más críticos es la preparación para las auditorías anuales de calidad y normativa; la dispersión de la documentación física y digital dificulta la recolección de evidencias, aumentando el riesgo de hallazgos negativos o sanciones por parte de los entes reguladores.

## 3. Solución Propuesta

Se propone el desarrollo de una plataforma tecnológica integral que centralice todos los procesos misionales de la compañía. El sistema no solo gestionará la parte académica, sino que actuará como un repositorio digital organizado para garantizar el cumplimiento normativo institucional.

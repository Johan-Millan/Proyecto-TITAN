...
```text
 Proyecto-TITAN
│
├──  0.PRESENTACION       # Integrantes del grupo y objetivos del proyecto.
├──  FASE 1/              # Historias de usuario iniciales, levantamiento de requerimientos.
├──  FASE 2/              # Diagramas E-R, UML (Clases y Despliegue), Mockups UI.
